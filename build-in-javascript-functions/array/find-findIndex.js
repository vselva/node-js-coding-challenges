...
console.log(
    ...
    firstNumberGreaterThan5,
    "Index: ",
    firstNumberGreaterThan5Index
);
...
console.log(
    "Removed negative number - the return value value (removed):",
    removed
);
...
numbers = [2, -3, 4, -1, 5];
console.log("original array - numbers:", numbers);
const replaced = numbers.splice(
    firstNegativeNumIndex,
    1,
    -numbers[firstNegativeNumIndex]
);
console.log(
    "Replaced first negative number with its positive number:",
    numbers
);
...
console.log(
    duplicateNum
        ? `Duplicate Number in the array is ${duplicateNum}`
        : "No duplicate number"
);
